...
from equipment.views import equipment_list, equipment_create, \
    edit_equipment, delete_equipment, show_xml, show_json, \
        show_xml_by_id, show_json_by_id, get_equipment, create_equipment_flutter, edit_equipment_flutter, delete_equipment_flutter
...
urlpatterns = [
    ...
    path('edit-equipment/<uuid:id>/', edit_equipment_flutter, name='edit_equipment_flutter'),
    path('delete-equipment/<uuid:id>/', delete_equipment_flutter, name='delete_equipment_flutter')
]