"""
Django settings for Lapa_NG project.
...
SECRET_KEY = 'django-insecure-=!hvsz_h=@bx&!71*r-5+c1z=^mqr#hx7o4kjg_+$e+)0%fcul'
...
WSGI_APPLICATION = 'Lapa_NG.wsgi.application'
...
STATICFILES_DIRS = [BASE_DIR / 'static']   # app-level static (css/js/images)
